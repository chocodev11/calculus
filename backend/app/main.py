...
from app.routers import auth_router, stories_router, courses_router, steps_router, progress_router, categories_router, shop_router, quests_router, admin_router, lessons_router, adaptive_router
